Param (
    [string]$vaAddress = "https://psrv12vra21.sccloudinfra.net:5480",
    [string]$ServiceUserName = "SCCLOUDINFRA\SA-Cat-svc_iaas",
    [string]$ServiceUserPassword = "9kZHKEA#opC9",
    [string]$vaRootUserPassword = "!ZwHpFf6qhTDs1",
    [string]$vaRootUserName = "root", 
    [string]$vaAddressCertThumbprint = "2C4BC04A50F714707C2A48C73898689AA1C93D9F", 
...
try
{
    ...
    Write-Host "Successfully installed Management Agent"
    exit 0
}
catch
{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUGxnOZ+3OTpk439IaYJwbrPlF
# rrGgghlLMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# IwYJKoZIhvcNAQkEMRYEFP9OTsP5K3CjMZilM+9vxmT9hXxjMCoGCisGAQQBgjcC
# AQwxHDAaoRiAFmh0dHA6Ly93d3cudm13YXJlLmNvbS8wDQYJKoZIhvcNAQEBBQAE
# ggEAAiouCAR6qvyml2ExZn8Ref4yXh93nmOCjXGNfr75AWu8fC6w5OepEb8+L8+2
# 5diIReTWpRYgTJ7CBDcBqxkpYj5+Yi2+TMgvKwroJ37QXsaa2+l0HUOze6rp8KZS
# DIiGsgwZBWn5dab0gT8WktTpGxUlkRYyx1qszWRaKoQu/idbbfvMXSecxMicWFqB
# wa+sP9YFiceMS/V3cInJnZ4YeieGCqJxW/iOxgurbpcOjsfNgfFaLqJpkr1jIaF0
# mAN6VUrIz163ukUuPqqL4kHnA/KnQDbw6K9/uel83ed8O8jC/jvfWXAtRUZ245EU
# U/KTYCeftWwRAZ8fPgxZNW6aQ6GCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB9AIB
...
# CwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xODA5MTIxODMyMzlaMCMGCSqG
# SIb3DQEJBDEWBBRHblpnOdm72e7BHeEetjvFn2wx6jANBgkqhkiG9w0BAQEFAASC
# AQApGnqzXD9CPPRhugjb2UC8YQqKpclUSKYEctbLTHVhIUd1jHCdXpJJywW+oKsd
# ptcjeE0opHzJhWpFh4Bh06WPZ7znDoRmuYgwiKxywl4M3f5CVm/bYw4fuvt9hsmp
# U9ANaQ0v0HsuKVvYvpp6xfCKg3LvPfZP0gHG+k/MKyPFgy/FMYYuO61zIlw4uNo2
# l+iv0wMURKBv+H8O2+H/U0yTQGT505IljbUSM0al78CbmXvDEazEIPFrNKeA5x/S
# pTdIW9jZHIoJ3J6d6r88eHsPqG9+FbxB8zqrlepOT2i6ttFUxDXWDUZLrzLTMqAa
# Bc2vptwixnxvZ6dESiPbUPRu
